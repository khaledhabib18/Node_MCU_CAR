...
#define flame A0
#define Buzzer 0
#define light_FR  16    //LED Front Right   pin A0 for Arduino Uno
#define light_FL  5     //LED Front Left    pin A1 for Arduino Uno
#define light_BR  4     //LED Back Right    pin A2 for Arduino Uno
#define pump D4    //Horn Buzzer       pin A4 for Arduino Uno
